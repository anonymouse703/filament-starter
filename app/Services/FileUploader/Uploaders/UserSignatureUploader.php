...
class UserSignatureUploader
{
    protected ?User $user;
    protected UploadedFile $uploadedFile;
    protected string $storagePath = 'users_e_signature';
    ...
    {
        $userSignatureUploader = new self($uploadedFile, $user);
        $userSignatureUploader->storagePath = 'users_e_signature';
        $userSignatureUploader->generateThumbnail = true;
        return $userSignatureUploader->upload();
    }
